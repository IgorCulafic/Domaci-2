...
Story_name = 'Bas Celik - lat'
my_text = docx2txt.process('C:/Users/Pommel Knight/Desktop/Domaci_2/Price/'+Story_name+".docx")
root.title(Story_name)
me_Knjige = ''
...
# Add Text Box
my_text = st.ScrolledText(my_frame, font=our_font)
...
"Times New Roman","Comic Sans","Calibri","Comic Sans","Papirus", "Roboto"